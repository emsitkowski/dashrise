  ...
  <Card class="relative h-full min-h-[320px] overflow-x-hidden overflow-y-visible">
    <template #card-body>
      <div class="relative flex flex-col justify-between h-full">
        ...
        <div
          class="absolute w-full bottom-0 flex justify-between items-center gap-4 bg-primary-4% px-4 sm:px-6 py-3 sm:py-4 mt-6 rounded-xl text-primary-600 z-[99999]"
        >
